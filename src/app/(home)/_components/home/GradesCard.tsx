export default function GradesCard() {
  ...
  return (
    <div className="flex-grow flex flex-col">
      ...
      <h2 className="mb-4">
        <b className="opacity-60">Quick Summary of Your Grades</b>
      </h2>
      <div className="flex flex-grow space-x-6 mt-1">
        {titles.map((x, i) => {
          return (
            <div className="bg-white rounded-md w-full p-8 space-y-2 h-full shadow-sm" key={i}>
              <p className="opacity-60">{x[0]}</p>
